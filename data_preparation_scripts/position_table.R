...
# Ensembl outputs all genes with no official gene name as "ensembl". Change this
# to "NA"
gtf$Gene_Name[grepl("ensembl", gtf$Gene_Name)] <- NA
...
gtf <- gtf[!grepl("ENSAMXT", gtf$Gene_Name), ]
